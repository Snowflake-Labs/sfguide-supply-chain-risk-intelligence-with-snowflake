...
including data sources, the NetworkX notebook, and technical architecture.
"""
...
def main():
    ...
    with col1:
        ...
        <div class="info-card">
            ...
            <p>
                ...
                that all three vendors source their raw materials from the same single refinery.
            </p>
            <p style="margin-top: 1rem;">
                ...
                is blindsided months later by sudden shortages.
            </p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        ...
        <div class="info-card">
            ...
            <p>
                ...
                <strong>NetworkX graph analysis</strong> to:
            </p>
            <ul style="color: #94a3b8; margin-top: 0.5rem;">
                <li>Infer common Tier-2+ relationships</li>
    ...
    with col2:
        ...
        st.markdown("""
        <p class="table-desc" style="margin-bottom: 0.75rem;">
            This demo uses synthetic trade data. In production, this layer would be sourced from 
            <strong>Snowflake Marketplace</strong> providers such as S&P Global Panjiva, Oxford Economics TradePrism, 
            FactSet, or Resilinc EventWatch—accessible via Snowflake credits with no separate data pipelines required.
        </p>
        """, unsafe_allow_html=True)
        st.markdown("""
        <div class="table-card">
    ...
    with col3:
        ...
        <div class="table-card">
            ...
            <span class="badge-output">NetworkX</span>
    ...
    # GNN NOTEBOOK
    # ============================================
    st.markdown('<div class="section-header">NetworkX Analysis Notebook</div>', unsafe_allow_html=True)
    ...
    with col1:
        ...
        <div class="info-card">
            ...
            <p>
                The Snowflake Notebook implements a complete network analysis pipeline using 
                <strong>NetworkX</strong> running natively in Snowflake.
            </p>
            <p style="margin-top: 1rem;">
            ...
            <ul style="color: #94a3b8;">
                ...
                <li><strong>Link Prediction:</strong> GraphSAGE encoder predicts common Tier-2+ relationships</li>
    ...
    with col1:
        ...
        <div class="workflow-step">
            <h4>1. Ingest</h4>
            <p>Integrate ERP and Trade data into Snowflake</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col3:
        ...
        <div class="workflow-step">
            <h4>3. Infer</h4>
            <p>Run NetworkX to predict links and propagate risk</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        ...
        <div class="info-card">
            ...
            <p style="margin-top: 1rem;">
                <strong>The Unknown Pattern:</strong> This demo reveals "Outback Lithium Resources"—a fictional Tier-2 supplier 
    ...
    <div class="info-card" style="margin-bottom: 1.5rem;">
        ...
        <p style="margin-top: 1rem;">
            The network analysis model then "walks" through this network, learning patterns like:
        </p>
        <ul style="color: #94a3b8; margin-top: 0.5rem;">
            <li><strong>Who supplies whom?</strong> Following the chain from raw materials to finished goods</li>
            <li><strong>Where do paths converge?</strong> Finding unknown chokepoints where multiple supply chains intersect</li>
            <li><strong>How does risk propagate?</strong> Understanding that a problem at Tier-3 will cascade to Tier-1</li>
            <li><strong>What relationships are we missing?</strong> Inferring unknown supplier connections from shipping patterns</li>
        </ul>
    </div>
    """, unsafe_allow_html=True)
    ...
    with col1:
        ...
        <div class="info-card" style="border-left: 4px solid #ef4444;">
            ...
            <p style="margin-top: 0.5rem;"><strong>Limitation:</strong> Completely misses network effects. A supplier with excellent scores can still be a single point of failure if they're the unknown source for multiple "independent" supply paths.</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col3:
        ...
        <div class="info-card" style="border-left: 4px solid #10b981;">
            <h3 style="color: #10b981;">NetworkX Approach</h3>
            <p><strong>Method:</strong> Combine internal ERP data with external trade intelligence. Let the AI discover unknown patterns and infer missing connections.</p>
    ...
    with col2:
        ...
        <div style="background: rgba(59, 130, 246, 0.1); border: 1px solid #3b82f6; border-radius: 12px; padding: 1.5rem; text-align: center;">
            ...
            <p style="color: #94a3b8; font-size: 0.8rem; margin-top: 0.5rem;">See beyond Tier-1 to discover unknown dependencies</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    <div class="info-card">
        ...
        <p style="margin-top: 1rem;">
            <strong>Graph analysis with NetworkX</strong> operates directly on graph-structured data. It computes node 
            representations by analyzing network topology and neighborhood structure through centrality measures and community detection. 
            This means a supplier's risk profile naturally incorporates information about what materials it supplies, 
    ...
    with col1:
        ...
        <div class="info-card">
            ...
            <p>At each iteration of the analysis, every node:</p>
...
Node Embeddings (used for link prediction + risk scoring)""", language=None)
    ...
    <div class="info-card" style="border-left: 4px solid #10b981;">
        ...
        <p style="margin-top: 0.5rem;">
            This network analysis approach answers: <em>"What suppliers exist that I don't know about, and how do they 
            create unknown concentration risks across my supposedly diversified supply base?"</em>
        </p>
        <p style="margin-top: 1rem;">
            The combination of <strong>internal ERP data</strong> (what we transact) with <strong>external trade intelligence</strong> 
            (what ships globally) enables inference of relationships that neither dataset reveals alone. The model learns 
            to connect the dots, surfacing the "Outback Lithium Resources" unknown bottlenecks that would otherwise remain 
    ...
    <div class="info-card">
        ...
        <ol style="color: #94a3b8; line-height: 2;">
            ...
            <li><strong>Execute the Notebook:</strong> Open the NetworkX notebook in Snowflake and run all cells to generate risk scores, predicted links, and bottlenecks</li>
    ...
    <p style="text-align: center; color: #64748b; font-size: 0.85rem; margin-top: 2rem;">
        Built with Snowflake | NetworkX | Streamlit
    </p>
    """, unsafe_allow_html=True)
