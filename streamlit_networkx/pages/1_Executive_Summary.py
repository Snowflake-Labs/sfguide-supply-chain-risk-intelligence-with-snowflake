...
def load_spend_at_risk(_session):
    ...
    try:
        result = _session.sql(f"""
            ...
            LEFT JOIN {DB_SCHEMA}.RISK_SCORES_NX rs ON po.VENDOR_ID = rs.NODE_ID
        """).to_pandas()
        return result
    except Exception:
        return pd.DataFrame()
...
def main():
    ...
    with col2:
        ...
        with kpi_col2:
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-trend trend-neutral">Unknown SPOFs</div>
            </div>
            """, unsafe_allow_html=True)
        ...
        with kpi_col4:
            ...
            <div class="kpi-card">
                ...
                <div class="kpi-label">Inferred Links</div>
        ...
        if bottleneck_summary is not None and not bottleneck_summary.empty:
            ...
            if at_risk > 0:
                ...
                <div class="insight-card">
                    ...
                    <p><strong>{at_risk} vendors</strong> depend on common Tier-2 suppliers 
    ...
    with col2:
        ...
        if not top_risks.empty:
            ...
            st.info("Run the NetworkX notebook to identify concentration risks.")
    ...
    <div class="value-highlight">
        ...
        <p>
            ...
            Reactive response to disruptions. Unknown concentration risks causing unexpected shortages.
        </p>
        <p style="margin-top: 0.75rem;">
            <strong>After:</strong> Minutes to identify common Tier-2+ relationships. 
