        ...
        if scenario_type == "Regional Disruption":
            ...
            if not bottlenecks.empty:
                ...
                selected_bottleneck_label = st.selectbox(
                    ...
                    help="Choose a common Tier-2 supplier to simulate failure"
                )
                ...
                <div style="background: rgba(30, 41, 59, 0.6); border-radius: 8px; padding: 1rem; margin-top: 1rem;">
                    <div style="color: #94a3b8; font-size: 0.85rem;">
                        ...
                        <div style="margin-top: 0.5rem; color: #64748b; font-size: 0.8rem;">{bottleneck_info.get('DESCRIPTION', 'Unknown supply chain convergence point')}</div>
                    </div>
                </div>
                """, unsafe_allow_html=True)
            else:
                st.warning("No bottlenecks identified. Run the NetworkX notebook first.")
                selected_bottleneck = None
