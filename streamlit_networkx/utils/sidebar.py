...
"independent" suppliers may depend on the same common Tier-2 source — creating concentration 
...
flows become edges. This structure enables the model to learn patterns and infer unknown relationships 
...
by trade evidence — transforming guesswork into data-driven insight."""
    ...
    "mitigation": {
        ...
        "content": """With unknown risks surfaced, the system prioritizes actions by impact and probability. 
