...
def load_data_statistics(_session):
    ...
    table_descriptions = {
        ...
        'PREDICTED_LINKS': 'Unknown relationships discovered by GNN',
...
def main():
    ...
    with col1:
        ...
        <div class="data-card" style="border-color: #10b981;">
            ...
            <p>{pl.get('description', '')} — common Tier-2+ relationships that the GNN discovered by analyzing trade patterns</p>
        </div>
        """, unsafe_allow_html=True)
